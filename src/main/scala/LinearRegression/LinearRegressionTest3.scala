...
/**
  * Created by cluster on 2017/4/12.
  */
object LinearRegressionTest3 {
  ...
  def main(args: Array[String]) {
    ...
    val dataList: List[(Int, Int, AnyVal, Double, AnyVal, AnyVal, Int, Int)] = List((3615, 3624, 2.1, 69.05, 15.1, 41.3, 20, 50708),(365, 6315, 1.5, 69.31, 11.3, 66.7, 152, 566432),(2212, 4530, 1.8, 70.55, 7.8, 58.1, 15, 113417),
    ...
    /**
      ...
      * HSGrad,Frost结霜天数(温度在冰点以下的平均天数) ,Area州面积
      */
    ...
    //预测谋杀率Murder
    //VectorAssembler():需要部分列的数据转换为特征向量，并统一命名，VectorAssembler类完成这一任务。VectorAssembler是一个transformer，将多列数据转化为单列的向量列。
    ...
    // RegParam：正则化
    // setMaxIter(10) 使得lr在拟合的时候最多迭代10次
    // setRegParam(0.3)设置正则化参数(泛化能力)
